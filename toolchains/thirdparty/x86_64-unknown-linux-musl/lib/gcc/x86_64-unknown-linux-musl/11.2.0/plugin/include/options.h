...
enum opt_code
{
  ...
  OPT_profile = 1910,                        /* -profile */
  OPT_pthread = 1911,                        /* -pthread */
  OPT_quiet = 1912,                          /* -quiet */
  OPT_r = 1913,                              /* -r */
  OPT_rdynamic = 1914,                       /* -rdynamic */
  OPT_remap = 1915,                          /* -remap */
  OPT_reverse_sort = 1916,                   /* -reverse-sort */
  OPT_s = 1917,                              /* -s */
  OPT_save_temps = 1918,                     /* -save-temps */
  OPT_save_temps_ = 1919,                    /* -save-temps= */
  OPT_shared = 1920,                         /* -shared */
  OPT_shared_libgcc = 1921,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1922,               /* -shared-libphobos */
  OPT_size_sort = 1923,                      /* -size-sort */
  /* OPT_specs = 1924, */                    /* -specs */
  OPT_specs_ = 1925,                         /* -specs= */
  OPT_static = 1926,                         /* -static */
  OPT_static_libasan = 1927,                 /* -static-libasan */
  OPT_static_libgcc = 1928,                  /* -static-libgcc */
  OPT_static_libgfortran = 1929,             /* -static-libgfortran */
  OPT_static_libgo = 1930,                   /* -static-libgo */
  OPT_static_libhwasan = 1931,               /* -static-libhwasan */
  OPT_static_liblsan = 1932,                 /* -static-liblsan */
  OPT_static_libmpx = 1933,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1934,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1935,               /* -static-libphobos */
  ...
  OPT_time = 2000,                           /* -time */
  OPT_time_ = 2001,                          /* -time= */
  OPT_tno_android_cc = 2002,                 /* -tno-android-cc */
  OPT_tno_android_ld = 2003,                 /* -tno-android-ld */
  OPT_traditional = 2004,                    /* -traditional */
  OPT_traditional_cpp = 2005,                /* -traditional-cpp */
  OPT_tree_stats = 2006,                     /* -tree-stats */
  OPT_trigraphs = 2007,                      /* -trigraphs */
  OPT_type_stats = 2008,                     /* -type-stats */
  OPT_u = 2009,                              /* -u */
  OPT_undef = 2010,                          /* -undef */
  OPT_v = 2011,                              /* -v */
  OPT_version = 2012,                        /* -version */
  OPT_w = 2013,                              /* -w */
  OPT_wrapper = 2014,                        /* -wrapper */
  OPT_x = 2015,                              /* -x */
  OPT_z = 2016,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
